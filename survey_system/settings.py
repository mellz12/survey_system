...
SECRET_KEY = 'django-insecure-=gh%wdvoxzx!46_-_k2936jsjowl&xlffqzye(g06#w#7b!5u!'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'survey_system' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Сессии для веб
    ],
